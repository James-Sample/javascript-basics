...
describe('containsVowels', () => {
  it('returns whether the given string contains vowels', () => {
	...
	expect(containsVowels('put')).toBe(true);
  	expect(containsVowels('NET')).toBe(true);
  	expect(containsVowels('hey')).toBe(true);
  	expect(containsVowels('rot')).toBe(true);
	expect(containsVowels('fill')).toBe(true);
